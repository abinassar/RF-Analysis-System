...
import { Frecuency, FrecuencyMultiplierFactor, FrecuencyUnit, GeoPoint, LinkSettings, defaultLinkSettings, defaultPoints, frecuenciesLicensed, frecuenciesUnits } from '@shared/models';
